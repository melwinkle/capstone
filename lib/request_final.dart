...
import 'package:lamber/users/map.dart';
...
class MyConfirmFPage extends StatefulWidget {
  const MyConfirmFPage({Key? key}) : super(key: key);

  @override
  ConfirmFpage createState() => ConfirmFpage();
}

class ConfirmFpage extends State<MyConfirmFPage> {
  int _currentIndex = 1;
